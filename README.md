...
![PSeCommerce – Google Analytics-Integration](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-google-analytics-tracking.png)

  Von dort aus können Sie PSeCommerce so konfigurieren, dass es mit dem auf Ihrer Website verwendeten Tracking-Code funktioniert (unabhängig davon, ob Sie den alten, neuen oder universellen Tracking-Code verwenden). **Store-Seiten** Wenn Sie den Schritt weiter oben in der Schnelleinrichtung zum Erstellen der Store-Seiten übersprungen haben, sollten Sie unbedingt zum Abschnitt „Store-Seiten“ unter: _Store-Einstellungen -> Präsentation_ gehen und diese Seiten einrichten hoch. Sie können für jede Shop-Seite auf die Schaltfläche „Seite erstellen“ klicken und PSeCommerce erstellt automatisch eine Seite für Sie:
...
![PSeCommerce – Shop-Einstellungen – Shop-Seiten erstellen](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-create-store-pages.png)
  ...
  **Produktattribute** In PSeCommerce werden diese auch als Variationen bezeichnet (auf die wir später eingehen). In diesem Abschnitt können Sie verschiedene Attribute für Ihre Produkte erstellen und ändern (z. B. Farbe, Größe, Gewicht usw.). Sie können auch die Art und Weise der Sortierung und die Sortierung anpassen und sogar neue Optionen zu einem vorhandenen Attribut hinzufügen. **Produktkategorien/Produkt-Tags** Da Sie mit ClassicPress Kategorien und Tags für Ihre Beiträge erstellen können, können Sie mit PSeCommerce über die Einstellungsseiten „Produktkategorien“ und „Produkt-Tags“ dasselbe für Ihre Produkte tun. Denn wenn es um die Bereitstellung von Produkten geht, möchte man es dem Kunden möglichst einfach machen, das zu finden, was er sucht. **Funktionen** Dieser Abschnitt ist praktisch, wenn Sie steuern möchten, wie andere Ihren Shop verwalten können, oder sogar jemandem erlauben möchten, Ihren gesamten Shop zu verwalten, ohne ihn zum Administrator Ihrer Website machen zu müssen! Tipp: Wenn Sie eine spezielle Rolle für einen Shop-Administrator erstellen möchten, können Sie dazu ein Plugin wie [Benutzerrollen-Editor](https://wordpress.org/plugins/user-role-editor/) verwenden (Eine einfache Möglichkeit wäre, die Rolle „Abonnent“ zu duplizieren und dann einfach die gewünschten Berechtigungen auf der Seite „Funktionen“ in PSeCommerce zuzuweisen.) Wir werden uns später noch mit einigen anderen Einstellungen befassen, aber zunächst einmal erstellen wir unser erstes Produkt!

### Produkte erstellen

Im PSeCommerce stehen drei Arten von Produkten zur Verfügung: physische, digitale und externe Produkte. Wir beginnen hier mit einem physischen Produkt (in diesem Beispiel einem T-Shirt), gehen die verschiedenen Aspekte der Konfiguration durch und gehen dann auf die einzigartigen Aspekte sowohl digitaler als auch externer Produkte ein. Als erstes auf unserer Agenda steht der Abschnitt „Produktart“, in dem Sie die Art des zu erstellenden Produkts auswählen können. Für unseren Beispielfall haben wir hier bereits den Typ „Physisches / materielles Produkt“ ausgewählt:

![PSeCommerce – Produktart](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-product-kind.png)

  Als nächstes haben wir den Abschnitt „Preis, Lagerbestand und Varianten“. Abhängig von der im Abschnitt „Produktart“ ausgewählten Produktart variieren die hier angezeigten Optionen. Nachfolgend finden Sie die Optionen, die Ihnen beim Erstellen eines physischen Produkts angezeigt werden:
...
![PSeCommerce – Preise, Lagerbestand und Varianten](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-price-inventory.png)
  ...
  Da wir derzeit ein physisches Produkt einrichten, gibt es in diesem Abschnitt einige Punkte zu beachten: _Richten Sie einen Verkauf für dieses Produkt ein:_ Wenn Sie planen, einen Verkauf für dieses Produkt durchzuführen, sollten Sie dies tun um diese Option zu aktivieren. Außerdem können Sie den Zeitraum angeben, für den dieser Verkauf gilt! _Sondersteuern:_ Wenn für Ihr Produkt ein anderer Steuersatz als in Ihren allgemeinen Einstellungen angegeben erforderlich ist, geben Sie hier den gewünschten Steuersatz ein. _Versandkosten berechnen:_ Wenn Sie Versandkosten berechnen, sollten Sie dieses Kontrollkästchen auf jeden Fall aktivieren, da Sie dann das Gewicht für Ihr Produkt angeben können (und ggf. eine zusätzliche Versandkostenpauschale). _Produktbestand verfolgen:_ Hier können Sie eine Menge für Ihr Produkt festlegen (und Sie können Kunden sogar erlauben, das Produkt zu kaufen, wenn es nicht vorrätig ist). Etwas unterhalb dieses Abschnitts sehen Sie nun auch den Abschnitt „Produktbilder“:

![PSeCommerce – Produktbilder](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-product-images.png)

  Hier können Sie ein oder mehrere Bilder für Ihr Produkt angeben (das erste Bild wird als Hauptbild verwendet), die dann als Galerie auf Ihrer Produktseite angezeigt werden. **Variationen** Ah, Variationen... damit wirst du viel Spaß haben. :) Anstatt mehrere Produkte für jeden Produkttyp zu erstellen (z. B. Herrenhemden, Damenhemden, weiße Hemden usw.), können Sie diese in Variationen innerhalb eines einzigen Produkts umwandeln! Wenn wir unser T-Shirt-Produktbeispiel hier fortsetzen, könnten Sie eine Version für Frauen und eine andere für Männer haben. Oder, um eine weitere Variante hinzuzufügen, könnten Sie T-Shirts für Männer und Frauen sowie kleine, mittlere und große Größen anbieten. Oder um noch eine weitere Variante in den Mix einzubringen, könnten Sie T-Shirts für Männer und Frauen in kleinen, mittleren und großen Größen anbieten, _und_ auch in einer Reihe von Farboptionen! Wie Sie sehen, gibt es viele Möglichkeiten! :) Im Feld „Variationen hinzufügen für“ können Sie so viele Namen und Werte erstellen, wie Sie möchten (oder bereits erstellte auswählen, wenn Sie dies über die zuvor erwähnte Seite „Produktattribute“ getan haben), indem Sie den dortigen Anweisungen folgen: 
...
![PSeCommerce – Produktvarianten erstellen](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-product-variants-create.png)
  ...
  Sobald die Variationen erstellt/ausgewählt wurden, werden Sie feststellen, dass die Abschnitte „Preis, Lagerbestand und Varianten“ und „Produktbild“ verschwinden und durch den Abschnitt „Produktvariationen“ ersetzt werden:
...
![PSeCommerce – Liste der Produktvarianten](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-product-variants-list.png)
  ...
  Von hier aus können Sie alle Ihre Variationen bearbeiten, von der Anpassung des Lagerbestands über die Änderung des Variationstyps bis hin zur Änderung der Preise usw. Ganz links in diesem Abschnitt können Sie für jede Variation ein Produktbild angeben Variation aufgeführt. Im Abschnitt „Mehr“ für eine Variante (dargestellt durch ein blaues Gitter ganz rechts) können Sie einige zusätzliche Eigenschaften für die Variante anpassen, die Sie zuvor im Abschnitt „Preis, Lagerbestand und Varianten“ gesehen haben:
...
![PSeCommerce – Produktvariantendetails](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-product-variant-details.png)
  ...
  Wenn Sie möchten, können Sie auch einige zusätzliche Inhalte für die Variation aus diesem Abschnitt hinzufügen. **Ähnliche Produkte** Lassen Sie uns nun in die Zukunft blicken und sagen, dass Ihr Kunde auf Ihrer Produktseite ist und sich Ihre T-Shirts ansieht. Aber während er dort ist, sieht er in der Rubrik „Ähnliche Produkte“ … ein Kleid aus Ihrem Geschäft, zusammen mit einer gepunkteten Krawatte und Clogs! Was wäre, wenn dort stattdessen eine Jeans, ein paar Turnschuhe und eine Baseballkappe auftauchen würden? Mit dieser Einstellung können Sie bestimmte Produkte in Ihrem Geschäft auswählen, die im Abschnitt „Ähnliche Produkte“ angezeigt werden, sodass Sie Ihren Kunden nun zum Kauf einer kompletten Garderobe verleiten, statt einer unpassenden Auswahl an Artikeln:

![PSeCommerce – Verwandte Produkte](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-lated-products.png)

  Herzlichen Glückwunsch, Sie haben gerade die Zukunft gerettet! (und das alles ohne Zeitmaschine) **Kategorien und Tags** Schließlich können Sie Kategorien und Tags zuweisen, die Sie für Ihre Produkte erstellt haben, sowie neue Kategorien und Tags erstellen, die Sie zuweisen möchten. Machen Sie Ihre Produkte einfach zu sortieren und zu finden, und Ihre Kunden werden es Ihnen danken. **Bei digitalen Produkten** Bei digitalen Produkten können auch Variationen angegeben werden, aber anstatt uns um Versanddetails zu kümmern, müssen wir stattdessen eine Datei von Ihrer Website angeben, die dem Produkt zugewiesen werden soll. Wie physische Produkte können auch digitale Produkte Variationen haben, wobei jeder Variation eine eigene Datei zugeordnet ist. Wenn Sie also Steuervorbereitungssoftware verkaufen, könnten Sie die Basic-, Premium- und Pro-Editionen der Software anbieten, jede Edition als separate Variante. **Bei externen Produkten** Bei externen Produkten besteht der einzige Zweck darin, Ihren Kunden an einen externen Ort zu leiten (z. B. einen Affiliate-Link, einen anderen Shop usw.), daher sind die Optionen hier minimal. Hier können eine SKU, ein Preis und ein Produktbild sowie ein Verkaufspreis festgelegt werden. Der Schwerpunkt liegt jedoch auf dem Feld „Externer Link“, in dem Sie den Link zu der Seite eingeben, auf die Sie Ihren Kunden weiterleiten möchten.

### Shortcodes

Okay, Sie haben Ihre Produkte erstellt, aber jetzt möchten Sie sie auf mehr als nur Ihren Produktseiten zeigen. Möglicherweise möchten Sie ein einzelnes Produkt auf einer Ihrer Seiten anzeigen oder auf einer Ihrer Seiten eine Liste von Produkten anzeigen, die zu einer bestimmten Kategorie gehören. Keine Angst, wir haben einen praktischen Shortcode-Generator im Editor, der über die im Screenshot unten hervorgehobene Schaltfläche „E-Commerce-Shortcode hinzufügen“ verfügbar ist:

![PSeCommerce – Shortcode-Generator](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-shortcode-generator.png)

  Wenn Sie darauf klicken, wird ein Popup angezeigt, in dem Sie über ein Dropdown-Menü einen der verfügbaren Shortcodes auswählen können:
...
![PSeCommerce – Shortcode-Generator-Popup](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-shortcode-generator-popup.png)
  ...
  Wenn ein Shortcode ausgewählt ist, erhalten Sie durch Klicken auf die einzelnen „i“-Symbolblasen zusätzliche Informationen zu einem Attribut. Sie sollten also darauf klicken, wenn Sie nicht ganz sicher sind, was eine Eigenschaft bewirkt.

### Bestellverlauf

Sie haben jetzt also Befehle von allen Toms, Dicks und Harrys... lasst uns sie verwalten! Von _Store -> Bestellungen_ aus können Sie alle Bestellungen verwalten und überprüfen, die auf Ihrer Website aufgegeben wurden:

![PSeCommerce – Bestellungen – Startseite](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-orders-home.png)

  Indem Sie mit der Maus über das Sternsymbol einer Bestellung fahren, können Sie den Status einer Bestellung schnell ändern:

![PSeCommerce – Bestellungen – Quick Flag](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-orders-quick-flag.png)

  Sie können eine Bestellung auch im Detail überprüfen, indem Sie auf den Link „Bearbeiten“ für eine bestimmte Bestellung klicken. Dort sehen Sie Details wie:
...
Zu finden unter: Store-Einstellungen -> Add-Ons. Sie sehen die in PSeCommerce verfügbaren Add-Ons, die variieren, je nachdem, ob Sie eine normale ClassicPress-Site oder eine Multisite-Installation ausführen. Für das Add-on „Coupons“ sehen Sie im Menüpunkt „Store“ einen neuen Untereintrag, über den Sie neue Coupons erstellen können:

![PSeCommerce – Gutscheine – Startseite](https://premium.wpmudev.org/wp-content/uploads/2010/06/mp-3006-coupons-home.png)

  Wenn Sie einen eigenen Coupon erstellen, werden Sie feststellen, dass es zwei bemerkenswerte Funktionen gibt:

1. Wie soll der Rabattbetrag angewendet werden? - Hierfür können Sie feststellen, ob:
...
2. Kann dieser Gutschein mit anderen Gutscheinen kombiniert werden? - Ja, bei uns können Sie selbst bestimmen, ob Gutscheine mit anderen Gutscheinen kombinierbar sind! (und um näher anzugeben, mit welchen anderen Coupons ein Coupon kombiniert werden kann)

Um die Coupon-Nachricht zu konfigurieren, die Kunden auf der Checkout-Seite angezeigt wird, klicken Sie auf der Add-Ons-Seite auf den Link „Einstellungen“ für das Add-on „Coupons“. Mit dem Add-on „Rechnungs-PDF“ können Sie nicht nur automatisch eine PDF-Rechnung mit Ihren Bestell-E-Mails versenden (und E-Mails auswählen, für die die Rechnung automatisch versendet werden soll), sondern auch die Rechnung manuell herunterladen eine PDF-Rechnung für eine Bestellung sowie den Lieferschein für eine Bestellung auf der Seite „Bestelldetails“: 
