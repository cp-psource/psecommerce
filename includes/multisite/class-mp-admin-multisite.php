...
class MP_Admin_Multisite {
	...
	public function init_theme_permissions_metabox() {
		$metabox = new PSOURCE_Metabox( array(
			...
			'site_option_name' => 'mp_network_settings',
			'desc'             => __( 'Festlegen von Theme-Zugriffsberechtigungen für Netzwerkspeicher. Speichere für ein benutzerdefiniertes CSS-Thema Deine CSS-Datei mit dem Header <strong> MarketPress Theme: NAME </strong> im Ordner <strong> /psecommerce/ui/themes/ </strong>, damit es in dieser Liste angezeigt wird.', 'mp' ),
			'order'            => 15,
		) );
