...
class PSOURCE_Field_WYSIWYG extends PSOURCE_Field {
	/**
	...
	public function on_creation( $args ) {
		...
		$this->args['class'] .= ' wp-editor-area psource-field-wysiwyg-textarea';
	...
	public function mce_external_plugins( $plugins ) {
		...
		$plugins['code'] = PSOURCE_Metabox::class_url('ui/js/tinymce.code.min.js');
		return $plugins;
	}
...
jQuery(document).ready(function($){
	...
	$(document).on('psource_repeater_field/stop_sort', function(e, $group){
		$group.find('.wp-editor-area').each(function(){
	...
	$(document).on('psource_repeater_field/after_add_field_group', function(e, $group){
		var $field = $group.find('.psource-field-wysiwyg'),
