...
class PSOURCE_Field_Checkbox_Group extends PSOURCE_Field {
	...
	public function display( $post_id = null ) {
		...
		$this->before_field();
		?>
		<div class="psource-checkbox-group <?php echo $this->args[ 'orientation' ]; ?>">
			<?php
			$index = 0;
			foreach ( $this->args['options'] as $value => $label ) {
				...
				$field = new PSOURCE_Field_Checkbox( array_replace_recursive( $this->args, apply_filters( 'PSOURCE_Field_Checkbox_Group_Arguments_' . $value, array(
					'conditional'   => false,
