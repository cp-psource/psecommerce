...
class PSOURCE_Field_File extends PSOURCE_Field {
	/**
	 * Runs on creation of parent
	 *Checjed 12.3.20 alles fein DN
	 * @since 1.0
	 * @access public
	 * @param array $args {
...
jQuery(document).ready(function($){
	...
	public function display( $post_id ) {
		...
		$this->before_field(); ?>
		<input type="text" <?php echo $this->parse_atts(); ?> value="<?php echo $value; ?>" /> <a class="button psource-field-file-select" href="#"><?php _e('Datei auswählen', 'psource_metaboxes'); ?></a>
		<?php
		$this->after_field();
	}
}