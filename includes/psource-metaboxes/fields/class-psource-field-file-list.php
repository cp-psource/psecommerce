 ...
 *
 * @class PSOURCE_Field_File_List
 */
class PSOURCE_Field_File_List extends PSOURCE_Field {
	...
	public function on_creation( $args ) {
        $this->args = array_replace_recursive(array(
			'title'         => __( 'Wähle die Datei aus, die Du verwenden möchtest.', 'psource_metaboxes' ),
			'button_label'  => __( 'Datei auswählen', 'psource_metaboxes' ),
		), $args);
        ...
        jQuery(function($) {
            ...
            */
            ...
            $('.psource-fields .add-file').on("click", function(e) {
                ...
                $('.psource-fields .file-list').append(newInput);
            });
		...
		<div class="file-list">
            ...
            if ( is_array( $values ) ){
                ...
                foreach( $values as $key => $value ){
                    ...
                    ?>
                    <div class="file">
                        <input type="text" <?php echo $this->parse_atts(); ?> value="<?php echo $value; ?>" /> <a class="button psource-field-file-select" href="#"><?php _e('Datei auswählen', 'psource_metaboxes'); ?></a><a href="#" class="button mp_file_action <?php echo $classes[0]; ?>-file"><span class="dashicons dashicons-<?php echo $classes[1]; ?>"></span></a>
                    </div>
                    <?php
                    $index++;
                }
            ...
            ?>
            <div class="file">
		        <input type="text" <?php echo $this->parse_atts(); ?> value="<?php echo $values; ?>" /> <a class="button psource-field-file-select" href="#"><?php _e('Datei auswählen', 'psource_metaboxes'); ?></a><a href="#" class="button mp_file_action add-file"><span class="dashicons dashicons-plus"></span></a>
            </div>
            <?php } ?>
		</div>
		<?php
