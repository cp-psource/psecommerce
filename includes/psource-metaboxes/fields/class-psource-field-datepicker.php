...
class PSOURCE_Field_Datepicker extends PSOURCE_Field {
		...
		<script type="text/javascript">
			( function( $ ) {
				$( document ).on( 'psource_repeater_field/before_add_field_group', function( e ) {
					$( 'input.psource-datepicker-field' ).datepicker( 'destroy' );
				} );
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'jquery-ui-smoothness-theme', PSOURCE_Metabox::class_url( 'ui/smoothness/jquery-ui.min.css' ), false, PSOURCE_METABOX_VERSION );
	}
