...
class MP_Shortcode_Builder {
	...
	public function enqueue_styles_scripts() {
		...
		if ( $page == 'shop-einstellungen'
			...
			wp_enqueue_script( 'mp-select2', mp_plugin_url( 'vendors/select2/select2.min.js' ), false, MP_VERSION );
	...
	public function media_buttons( $editor_id ) {
		 ...
		 *
		 * @param bool   $sc_builder Enable or Disable.
		 * @param string $editor_id Current editor id.
		 *
		 * @since 3.2.10
		 */
		$sc_builder = apply_filters( 'mp_media_buttons', $sc_builder, $editor_id );
