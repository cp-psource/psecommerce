...
( function( $ ) {
    ...
    mp_cart.updateProductAttributes = function() {
        ...
        $.post( url, jQuery.param( form_data ) ).done( function( resp ) {
            ...
            psecommerce.loadingOverlay( 'hide' );
            psecommerce.ajaxEvent( 'mp_cart/after_update_product_attributes', resp );
    ...
    mp_cart.addItem = function( $form, item, qty ) {
        ...
        $.ajaxq( 'addtocart', {
            ...
            .done( function( resp ) {
                psecommerce.ajaxEvent( 'mp_cart/after_add_item', resp, $form );
    ...
    mp_cart.updateItemQty = function( itemId, qty, $scope ) {
        ...
        $.post( url, data ).done( function( resp ) {
            psecommerce.loadingOverlay( 'hide' );
            psecommerce.ajaxEvent( 'mp_cart/update_item_qty', resp, $scope );
