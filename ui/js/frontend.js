    ...
    psecommerce = {
        ...
        initProductFiltersPagination: function() {
            ...
            /*$( '#mp_product_nav' ).parent( ).on( 'click', '#mp_product_nav a', function( e ) {
                ...
                var query = psecommerce.unserialize( href );
        ...
        updateProductList: function() {
            ...
            $.post(url, data).done(function(resp) {
                psecommerce.loadingOverlay('hide');
        ...
        initGlobalProductFiltersPagination: function() {
            ...
            $form.on('change', 'select', function(e) {
                ...
                if ('product_category' == $this.attr('name')) {
                    ...
                    psecommerce.updateGlobalProductList();
                }
            });
        },
        /**
...
jQuery(function() {
    psecommerce.initSelect2();
    psecommerce.initProductTabs();
    psecommerce.initToolTips();
    psecommerce.initOrderLookup();
    psecommerce.initImageLightbox();
    psecommerce.initProductFiltersPagination();
    psecommerce.initGlobalProductFiltersPagination();
    psecommerce.getViewportSize();
});