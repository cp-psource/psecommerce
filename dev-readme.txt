...
* Localization files (.mo) can now be loaded from wp-content/language/psecommerce/mp-{your locale}.mo
...
* Added https support for custom styles in the wp-content/psecommerce-styles/ directory.
...
* Added APO state codes to the psecommerce-data.php so addresses can make it past PayPal's address checker,
...
* Fix issue with Stripe payment gateway JS conflict. http://premium.wpmudev.org/forums/topic/psecommerce-problem-cant-finish-checking-out
...
* Fix bug in Payflow Pro gateway: http://premium.wpmudev.org/forums/topic/psecommerce-payflow-pro-not-sending-info-to-paypal
...
* Add support for custom css files in /wp-content/psecommerce-styles/ folder to avoid overwriting on updates
...
* Fix negative quantities being able to be added to your cart: http://premium.wpmudev.org/forums/topic/psecommerce-security-bug
...
* Hook into logout to clear personal session information: http://premium.wpmudev.org/forums/topic/security-issue-with-psecommerce
...
* Fixed http://premium.wpmudev.org/forums/topic/psecommerce-template-page-mp_global_productsphp-works-but-browsers-title-says-page-not-found?replies=20#post-72045
...
* new mp_is_shop_page() template function http://premium.wpmudev.org/forums/topic/psecommerceload_store_templates-should-make-is_shop_page-available
